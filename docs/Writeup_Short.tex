...
%    {\small
    \begin{tcolorbox}[fonttitle=\bfseries, title=IQL-QRE ]
    \begin{algorithm}[H]
...
\begin{itemize}
    ...
    \item Noise is sufficient for contrasting strategy   \footnonte{e.i. there exists dis-coordination and vulnerability to partner uncertainty}
